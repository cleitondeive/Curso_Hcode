...
<div class="container">
	<div class="colxs12">
		<h1 class="h1-titulocor">08-Aula-Hcode-include e require-02.php</h1>
	</div>
...
<!--inicio do Curso Php-->
 ...
 <?php
	//Conhecendo 08-Aula-Hcode-include e require.php
require "08-Aula-Hcode-include e require.php";

   $resultado = somar(950 , 20);
		echo "$resultado";
